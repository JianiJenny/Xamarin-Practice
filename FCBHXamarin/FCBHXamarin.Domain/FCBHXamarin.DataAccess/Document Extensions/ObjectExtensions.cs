...
using FCBHXamarin.DataAccess.Document_Extensions.Attributes;
...
namespace FCBHXamarin.DataAccess.Document_Extensions
{
    ...
    public static class ObjectExtensions
    {
                                       ...
                                       IPropertyNameConverter propertyNameConverter = null)
        {
            ...
            else if (!propertyType.IsSimple() && !propertyType.IsEnum && (propertyType.IsClass || propertyType.IsInterface) && propertyValue != null)
            {
                if (typeof(IEnumerable).IsAssignableFrom(propertyType))
                {
                    ...
                    else
                    {
                        ...
                        foreach (var item in items)
                        {
                            ...
                            internalDictionary.Add("$type", $"{item.GetType()}, Vessel.Models");
